...
load("knitr/car-iar-poisson/nyc_subset.data.R");

nyc_shp<-readOGR("knitr/car-iar-poisson/nycTracts10", layer="nycTracts10");
...
source("knitr/car-iar-poisson/nb_data_funs.R");
